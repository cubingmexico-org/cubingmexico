...
import type { ShareHighlight, ShareHighlightTone } from "../_lib/share-types";
...
export const SummaryShareCardShell = forwardRef<HTMLDivElement, Props>(
  function SummaryShareCardShell(
    {
      subtitle,
      identity,
      highlights,
      cardDataAttr = "data-summary-share-card",
    },
    ref,
  ) {
        ...
        <div className="relative z-10 flex h-full flex-col px-14 pt-16 pb-12">
          <header className="flex shrink-0 items-center gap-5">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[32px] text-neutral-500">{subtitle}</p>
            </div>
          </header>

          <div className="mt-10 shrink-0">{identity}</div>
